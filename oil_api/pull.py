...
def rename_resources(package: PackageWrapper):
    ...
    package.pkg.descriptor['resources'][1]['path'] = 'oil_api/data/brent_weekly.csv'
    package.pkg.descriptor['resources'][2]['name'] = 'brent-month'
    package.pkg.descriptor['resources'][2]['path'] = 'oil_api/data/brent_monthly.csv'
    package.pkg.descriptor['resources'][3]['name'] = 'brent-year'
    package.pkg.descriptor['resources'][3]['path'] = 'oil_api/data/brent_yearly.csv'
    package.pkg.descriptor['resources'][4]['name'] = 'wti-daily'
    package.pkg.descriptor['resources'][4]['path'] = 'oil_api/data/wti_daily.csv'
    package.pkg.descriptor['resources'][5]['name'] = 'wti-week'
    package.pkg.descriptor['resources'][5]['path'] = 'oil_api/data/wti_weekly.csv'
    package.pkg.descriptor['resources'][6]['name'] = 'wti-month'
    package.pkg.descriptor['resources'][6]['path'] = 'oil_api/data/wti_monthly.csv'
    package.pkg.descriptor['resources'][7]['name'] = 'wti-year'
    package.pkg.descriptor['resources'][7]['path'] = 'oil_api/data/wti_yearly.csv'
